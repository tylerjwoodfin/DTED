...
namespace DTEDCapstone.Plotter
{
    /*Class handles the interface with GNUPlot.
     Code was pulled from GitHub at
    ...
    class GnuPlot
    {
        ...
        internal static void SPlot(Func<int, int> getLength1, Func<int, int> getLength2, double[] z, string v)
        {
            throw new NotImplementedException();
        }

        internal static void SPlot(int v1, int v2, double[] z, string v3)
        {
            throw new NotImplementedException();
        }
